...
const ProductPage: React.FC = () => {
  ...
  const [product, setProduct] = useState<Product>({
    ...
    colors: [
      ...
      { name: "Phantom Black", hex: "#000000", available: true },
      { name: "Phantom White", hex: "#FFFFFF", available: true },
      { name: "Green", hex: "#008000", available: false },
    ],
    storageOptions: ["128GB", "256GB", "512GB"],
    features: [
      '6.8" Dynamic AMOLED 2X Display with 120Hz refresh rate',
      "108MP Pro-grade Camera with Night Mode",
      "Snapdragon 8 Gen 1 Processor",
      "5000mAh All-Day Battery",
      "Built-in S Pen with 2.8ms latency",
    ],
    description:
      "The Samsung Galaxy S22 Ultra is the ultimate smartphone for power users...",
    specifications: {
      "Model Name": "Galaxy S22 Ultra",
      "Operating System": "Android 12 with One UI 4.1",
      Processor: "Snapdragon 8 Gen 1",
      RAM: "12GB",
      Storage: "128GB/256GB/512GB (no card slot)",
  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      content:
        "The camera is phenomenal, battery lasts all day, and the S Pen integration is seamless. Worth every penny!",
      verified: true,
    },
    {
      id: "2",
      ...
      content:
        "Amazing performance and display, but it's quite heavy compared to previous models. Still love it though.",
      verified: true,
    },
  ]);
      ...
      answers: [
        {
          ...
          answer:
            "Yes, the Galaxy S22 Ultra supports both wired fast charging (45W) and wireless charging (15W).",
          date: "March 5, 2025",
        },
      ],
      date: "March 1, 2025",
      ...
      answers: [
        {
          ...
          user: "MegaMart Support",
          answer:
            "Yes, the S Pen comes included with the Galaxy S22 Ultra and has a dedicated slot in the phone.",
          date: "March 8, 2025",
        },
      ],
      date: "March 3, 2025",
